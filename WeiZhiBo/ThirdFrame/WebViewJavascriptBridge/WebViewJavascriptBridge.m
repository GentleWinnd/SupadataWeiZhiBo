...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    if (webView != _webView) { return; }
    if ([self.WJDelegate respondsToSelector:@selector(WJWebViewLoadFinished:)]) {
        [self.WJDelegate WJWebViewLoadFinished:webView];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    if (webView != _webView) { return; }
    if ([self.WJDelegate respondsToSelector:@selector(WJWebViewLoadFailed:withError:)]) {
        [self.WJDelegate WJWebViewLoadFailed:webView withError:error];
    }
    __strong WVJB_WEBVIEW_DELEGATE_TYPE* strongDelegate = _webViewDelegate;
...
- (void)webViewDidStartLoad:(UIWebView *)webView {
    if (webView != _webView) { return; }
    if ([self.WJDelegate respondsToSelector:@selector(WJWebViewStartLoad:)]) {
        [self.WJDelegate WJWebViewStartLoad:webView];
    }
    __strong WVJB_WEBVIEW_DELEGATE_TYPE* strongDelegate = _webViewDelegate;
